...
@section('container')
  ...
  <div class="table-responsive small col-lg-4">
    <a href="/dashboard/kategoriartikel/create" class="btn btn-primary mb-3">Tambah Kategori</a>
      ...
      <tbody>
        ...
        <tr class="table-primary">
          ...
          <td>
            ...
            <a href="/dashboard/kategoriartikel/{{ $p->slug }}/edit" class="badge bg-warning"><span><i class="bi bi-pencil-square"></i></span></a>
            <form action="/dashboard/kategoriartikel/{{ $p->slug }}" method="POST" class="d-inline">
                @method('delete')
                @csrf
