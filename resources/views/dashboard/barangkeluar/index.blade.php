...
{{-- Tabel Riwayat Barang Keluar --}}
  ...
  @auth
  <div class="col-md-3 m-3 d-flex justify-content-start">
    <button onclick="confirmExport()" class="btn btn-success me-2"><i class="bi bi-file-earmark-spreadsheet"></i> Excel</button>
    ...
    <div class="table-responsive">
      <table class="table table-bordered table-striped table-hover table-sm" id="myTable" data-sort-order="asc">
        ...
        <tbody>
          @php
            $totalQty = 0;
            $offset = $isPaginated ? ($barangKeluar->currentPage() - 1) * $barangKeluar->perPage() : 0;
          @endphp
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="editForm" method="POST">
            ...
            <div class="mb-3">
                <label for="edit-jamlive" class="form-label">Waktu</label>
